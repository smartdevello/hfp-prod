...
add_filter('of_sanitize_logo_builder', 'of_sanitize_logo_builder');

function of_sanitize_logo_builder($input) {
...
function of_sanitize_selectmultiple($input, $option) {
    return $input;
}

add_filter('of_sanitize_selectmultiple', 'of_sanitize_selectmultiple', 10, 2);
...
add_filter('of_sanitize_cust_sidebars', 'of_sanitize_sidebars');


function of_sanitize_sliders($input) {
    return $input;
}

add_filter('of_sanitize_add_slide', 'of_sanitize_sliders');
function of_sanitize_create_slider($input) {
    return $input;
}

add_filter('of_sanitize_create_slider', 'of_sanitize_create_slider');
/**
...
function admg_sanitize_social_icons( $output ) {
	return $output;
}

add_filter( 'of_sanitize_cust_social', 'admg_sanitize_social_icons' );