jQuery(document).ready(function($) {
    ...
    function motherInfoSubmission() {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                action: 'babystorkpumps_register_login_onestep_form',
    ...
    function primaryInsuranceSubmission() {
        ...
        form_data.append('action', 'babystorkpumps_step_2_onestep_form');
    ...
    function accessoriesSubmission() {
        ...
        var form_data = new FormData();
        form_data.append('action', 'babystorkpumps_step_3_onestep_form');
    ...
    function initValidation() {
        ...
        jQuery.validator.addMethod("DBN", function(value, element, param){
            ...
            jQuery('#dodNumber').css('color', 'red');
            return false;
        }, "It doesn't look like your DBN or Policy Number is in the correct format. <br> If you feel like this is an error, please contact support at <a href='mailto:info@babystorkpumps.com'>info@babystorkpumps.com</a> or <b>click the support icon to the bottom right.</b>");
