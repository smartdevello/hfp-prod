<div class="motherInfo_tab">
	...
	<div class="form-group">
		<label>Phone Number <span class="ast">*</span></label>
	...
	<?php if (!is_user_logged_in()) { ?>
		<div class="form-group" id="email_div">
			...
			?>
			<input id="email" type="text" class="form-control" name="email" placeholder="Email" value="<?php echo $user_email_cookie ?>" required>
		</div>
