	...
	<div class="entry-content row">
		...
		<div class="span3">
			...
			<p class="gallery-meta">
				...
				<?php
				printf(
					_n( 'This gallery contains <strong>%1$s photo</strong>.', 'This gallery contains <strong>%1$s photos</strong>.', $creiden_total_images, 'the-bootstrap' ),
