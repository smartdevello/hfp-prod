...
?>
    <div class="form-group option_sets_selector">
        ...
        <div style="font-weight: bold;">There are three ways to validate your prescription. Please choose the option that best fits you: <span class="ast">*</span></div>

        <div class="prescription_select_div">
            <?php $saved_validate_prescription = ((isset($validate_prescription) && $validate_prescription == 'option_set1') || !isset($validate_prescription))  ? 'checked' : '';
            ?>
    ...
    <div class="form-group option_set" id="option_set1" >
        <div class="custom_file_input_div">
            ...
            <p>
                <span class="form-text">Please take a good picture of yourself in clear lighting in front of a background that is a different color than your clothing.  We will need to be able to match the photo from your drivers license to this photo.</span>
            </p>
            <?php
        ...
        <div class="custom_file_input_div">
            ...
            <p>
                <span class="form-text">Please take a good picture of your drivers license.  Make sure the lighting is good and free from glare and that the license is legible and in focus.</span>
            </p>
            <?php
