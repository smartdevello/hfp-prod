...
add_action('wp_ajax_homefrontpump_register_login_onestep_form', 'homefrontpump_register_login_onestep_form');
add_action('wp_ajax_nopriv_homefrontpump_register_login_onestep_form', 'homefrontpump_register_login_onestep_form');

function homefrontpump_register_login_onestep_form()
{
...
add_action('wp_ajax_homefrontpump_step_2_onestep_form', 'homefrontpump_step_2_onestep_form');
add_action('wp_ajax_nopriv_homefrontpump_step_2_onestep_form', 'homefrontpump_step_2_onestep_form');
function homefrontpump_step_2_onestep_form()
{
	...
	if (!empty($post_data['dodNumber'])) {
		...
		$error = '<li>DoD Number is missing</li>';
	}
...
add_action('wp_ajax_homefrontpump_step_3_onestep_form', 'homefrontpump_save_step_3_onestep_form');
add_action('wp_ajax_nopriv_homefrontpump_step_3_onestep_form', 'homefrontpump_save_step_3_onestep_form');
function homefrontpump_save_step_3_onestep_form()
{
