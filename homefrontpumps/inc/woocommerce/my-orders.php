...
add_action( 'woocommerce_before_account_orders', function () {
	...
	echo "<a href='".get_site_url().'/reorder'."' class='woocommerce-button button reorder' style='margin-bottom: 25px; background-color: #FFB401; color: #fff; padding: 15px 40px;'>Place your order</a>";
} );